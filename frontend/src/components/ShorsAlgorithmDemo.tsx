...
const ShorsAlgorithmDemo: React.FC = () => {
  ...
  const [numberToFactor, setNumberToFactor] = useState<number>(15);
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">
              Shor's Algorithm Interactive Demo
            </h1>
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg mx-auto max-w-3xl">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Shor's algorithm is a quantum algorithm developed by Peter Shor
                in 1994 that can efficiently factor large integers, breaking RSA
                encryption in polynomial time instead of exponential time. This
                interactive demo shows how the algorithm works by finding the
                period of a function, which is the key step in the factoring
                process.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="col-span-1 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <div className="mt-4 text-xs text-gray-500 italic text-center">
                Note: This is a simulation that demonstrates the concepts, not
                an actual quantum computation.
              </div>
            </div>
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      The quantum Fourier transform converts phase information
                      into measurement probabilities. Peaks indicate the phase
                      is a multiple of 1/r.
                    </p>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                    ...
                    <p className="text-xl">{results.factors.join(" and ")}</p>
          ...
          <div className="mt-12 mx-auto max-w-4xl">
            ...
            {step === 1 && (
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-4">
                  The Math Behind Shor's Algorithm
                </h3>
                <p className="mb-4">
                  At its core, Shor's algorithm transforms the factoring problem
                  into a period-finding problem. For a number N that we want to
                  factor, we choose a random number a (coprime to N) and look
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg overflow-x-auto">
                  <h4 className="font-medium mb-2">
                    Pattern of a^x mod N for chosen values:
                  </h4>
                ...
                <div className="mt-6">
                  ...
                  <p>
                    The function f(x) = a^x mod N is periodic, meaning there
                    exists some value r where f(x+r) = f(x). If we can find this
                    period r, we can likely factor N by computing gcd(a^(r/2) ±
                    1, N). Classical computers take exponential time to find
                    this period, but quantum computers can do it efficiently!
                  </p>
                </div>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <p className="mb-4">
                  A quantum computer can find this period efficiently using a
                  circuit with two main parts:
                </p>
                <ol className="list-decimal pl-6 mb-4">
                  <li className="mb-2">
                    <strong>Input Register:</strong> A register of qubits in
                    superposition, allowing us to evaluate f(x) = a^x mod N for
                    many values of x simultaneously
                  </li>
                  <li className="mb-2">
                    <strong>Quantum Fourier Transform (QFT):</strong> Extracts
                    the period from these evaluations
                  </li>
                </ol>
                ...
                <div className="mt-6">
                  ...
                  <p>
                    This circuit leverages quantum superposition and
                    interference to extract the period efficiently. While a
                    classical computer would need to try each value of x
                    individually (exponential time), a quantum computer can
                    examine all values simultaneously and extract the pattern
                    (polynomial time).
                  </p>
                </div>
              </div>
            ...
            {step === 3 && (
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <p className="mb-4">
                  Once we have the period r, we can find the factors of N with
                  high probability:
                </p>
                <ol className="list-decimal pl-6 mb-4">
                  <li className="mb-2">
                    If r is even, compute gcd(a^(r/2) - 1, N) and gcd(a^(r/2) +
                    1, N)
                  </li>
                  <li className="mb-2">
                ...
                {results && (
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <h4 className="font-medium mb-2">
                      Calculations with our results:
                    </h4>
                    <p className="font-mono">Period (r) = {results.period}</p>
                    {results.period % 2 === 0 ? (
                      <>
                        <p className="font-mono">
                          a^(r/2) = {a}^({results.period}/2) ={" "}
                          {Math.pow(a, results.period / 2)}
                        </p>
                        <p className="font-mono">
                          gcd(a^(r/2) - 1, N) = gcd(
                          {Math.pow(a, results.period / 2) - 1}, {N}) ={" "}
                          {results.factors[0] || "?"}
                        </p>
                        <p className="font-mono">
                          gcd(a^(r/2) + 1, N) = gcd(
                      ...
                      <p className="font-mono">
                        Note: Since r is odd, we need to try a different value
                        of a.
                      </p>
                    )}
                    <p className="font-mono mt-2">
                      Therefore, factors of {N} are:{" "}
                ...
                <div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                  <h4 className="font-medium mb-2">
                    Why RSA Encryption is Threatened:
                  </h4>
                  <p>
                    RSA security depends on the difficulty of factoring large
                    numbers. With 2048-bit RSA keys, factoring would take
                    billions of years for classical computers. A sufficiently
                    powerful quantum computer using Shor's algorithm could break
                    the same key in hours or minutes.
                  </p>
                  <p className="mt-2">
                    This is why organizations need to transition to post-quantum
                    cryptography before large-scale quantum computers become
                    available.
                  </p>
                </div>
              </div>
