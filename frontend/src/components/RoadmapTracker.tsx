...
import { FiArrowLeft, FiCheckSquare, FiSquare, FiSun, FiMoon, FiLock, FiCalendar, FiFilter, FiPlus, FiEdit2, FiTrash2, FiLoader, FiAlertTriangle, FiGrid, FiList, FiX, FiChevronDown } from 'react-icons/fi';
...
const initialRoadmapData: RoadmapCategory[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        status: 'In Progress',
        phase: 3,
        notes: 'Created initial algorithm mapping system with cipher_mappings.py. TLS handshake analysis visualization component in development.'
      },
      {
        id: 'network-4',
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: 'ux-6',
        title: 'UI Layout Consistency',
        description: 'Ensure consistent UI elements and layout across all application pages',
        category: 'ux',
        priority: 'High',
        status: 'Complete',
        phase: 2,
        notes: 'Created reusable Header and Footer components, ensuring consistent navigation and branding across all pages. Fixed alignment issues in the Footer.'
      }
    ]
  },
  {
