        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center mb-4 md:mb-0">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-gray-700 dark:text-gray-300">qvspro.app</span>
            </Link>
          </div>
          
          <div className="text-center md:text-right text-sm text-gray-600 dark:text-gray-400">
            <p>Quantum Vulnerability Scanner © {new Date().getFullYear()} | <a href="https://qvspro.app" className="hover:underline">qvspro.app</a></p>
