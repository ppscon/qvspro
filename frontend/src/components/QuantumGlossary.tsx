          ...
          <div className="text-center mb-8">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg mx-auto max-w-3xl">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                This glossary provides definitions for key terms in quantum
                computing, post-quantum cryptography, and quantum security.
                Understanding these concepts is essential for navigating the
                rapidly evolving landscape of quantum-safe security.
              </p>
            </div>
          </div>
